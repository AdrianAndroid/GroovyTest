...
public class BaiduConfig {
    ...
    static {
        ...
        TRANS_MAP.put(VALUES_AR, "ara");
        TRANS_MAP.put(VALUES_DE, "de");
        TRANS_MAP.put(VALUES_ES, "spa");
        TRANS_MAP.put(VALUES_FR, "fra");
        TRANS_MAP.put(VALUES_IN, "id");
        TRANS_MAP.put(VALUES_IT, "it");
        TRANS_MAP.put(VALUES_JA, "jp");
        TRANS_MAP.put(VALUES_KO, "kor");
        TRANS_MAP.put(VALUES_MS, "may");
